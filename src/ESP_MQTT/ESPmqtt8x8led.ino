...
char* mqtt_topic = "/esp12F3/answer" ;//"esp1s"; //MQTT topic for communication
...
char* mqtt_sub = "/home/esp12f3/command";
...
void setup() {
  ...
  Serial.begin(9600);
  ledMatrix.init();
  ledMatrix.setText("finished setup...");
  led_display();
 // msg[0] = '\0';
}
...
void listen_master()
{
    ...
    if (i==0) return;
    set_end_mark(i);
    ledMatrix.setNextText((char*)msg); 
    led_display();
